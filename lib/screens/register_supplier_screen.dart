                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      child: Icon(Icons.local_shipping, size: 40, color: Theme.of(context).colorScheme.primary),
                    ),
                      ...
                      child: Column(
                        children: [
                          ...
                          OutlinedButton.icon(
                            ...
                            label: Text('Already have an account? Login', style: TextStyle(color: Theme.of(context).colorScheme.primary)),
